...
// Get quiz ID
$quizId = $_GET["q"];
if (!is_numeric($quizId)) header("Location: guesthome.php"); // If quiz ID is not passed as a number then go home.
...
if ($result->num_rows == 1) { // load quiz parameters into session vars
  ...
  $_SESSION["resultsPage"] = "guestresults.php";
  $_SESSION["reviewPage"] = "guestreview.php";
