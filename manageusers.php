...
<nav class="navbar navbar-expand-sm bg-success navbar-dark static-top">  
  <div class="container">
    <a class="navbar-brand" href="#">
        ...
        </a><p class="mb-2 text-white">Quizler!<br /><b>Manage Users</b></p>
...
<h3 class="mt-3">Manage Users&nbsp;&nbsp;&nbsp;<button type="button" onclick="window.location.href='edituser.php?id=-1'" class="btn btn-success btn-sm">&nbsp;&nbsp;Add&nbsp;&nbsp;</a></button></h3>
...
while($row = $result->fetch_assoc()) {  // Loop through users
  echo "<tr><td>" . $row["firstname"] . " " . $row["lastname"] . " - " . $row["permission"] . "<br />";
  echo "<a href=\"mailto:" . $row["email"] . "\">". $row["email"] . "</td><td align='right'>";
  echo "<button type=\"button\" class=\"btn btn-success btn-sm\" onclick=\"window.location.href='edituser.php?id=" . $row["id"] . "'\">&nbsp;&nbsp;Edit&nbsp;&nbsp;</a></button> \n";
  ?>
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
		    ...
		    <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="edituserdelete.php?id=<?php echo $row['id'];?>">Delete</a>
